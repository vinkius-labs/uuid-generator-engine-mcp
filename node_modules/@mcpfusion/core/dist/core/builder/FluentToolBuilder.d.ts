...
export declare class FluentToolBuilder<TContext, TInput = Record<string, never>, TCtx = TContext> {
    ...
    /** @internal */ _handlerSet: boolean;
    /** @internal */ _fsmStates?: string[];
    /** @internal */ _fsmTransition?: string;
    /** @internal */ _interactive: boolean;
     ...
     * ```
     */
    withJson<K extends string>(name: K, description?: string): FluentToolBuilder<TContext, TInput & Record<K, Record<string, unknown>>, TCtx>;
    /**
     ...
     * @returns Builder with narrowed `TInput` type
     */
    withOptionalJson<K extends string>(name: K, description?: string): FluentToolBuilder<TContext, TInput & Partial<Record<K, Record<string, unknown>>>, TCtx>;
    /**
     ...
     * ```
     */
    use<TDerived extends Record<string, unknown>>(mw: MiddlewareDefinition<TCtx, TDerived>): FluentToolBuilder<TContext, TInput, TCtx & TDerived>;
     ...
     * ```
     */
    bindState(states: string | string[], transition?: string): FluentToolBuilder<TContext, TInput, TCtx>;
    /**
