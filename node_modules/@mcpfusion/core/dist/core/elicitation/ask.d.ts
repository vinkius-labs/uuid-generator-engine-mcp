...
import { type AskField, type AskResponse, type InferAskFields, type ElicitSink, type JsonSchemaProperty, AskStringField, AskNumberField, AskBooleanField, AskEnumField } from './types.js';
/**
 ...
 * @internal
 */
export declare const _elicitStore: AsyncLocalStorage<ElicitSink>;
/**
 ...
 * @internal
 */
export declare function compileAskFields(fields: Record<string, AskField<any>>): {
    type: 'object';
...
export interface AskFunction {
     ...
     * ```
     */
    <T extends Record<string, AskField<any>>>(message: string, fields: T): Promise<AskResponse<InferAskFields<T>>>;
    /**
