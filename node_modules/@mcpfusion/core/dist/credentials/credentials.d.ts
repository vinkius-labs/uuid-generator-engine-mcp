...
export type CredentialType = 'api_key' | 'token' | 'password' | 'url' | 'connection_string' | 'string' | 'number' | 'email' | 'boolean' | 'select' | 'oauth2';
/**
 ...
 * ```
 */
export declare function optionalCredential(key: string): string | undefined;
