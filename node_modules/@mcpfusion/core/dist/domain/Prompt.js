 ...
 * @example
 * ```typescript
 * import { Prompt, PromptArgument } from '@mcpfusion/core';
 *
...
export class Prompt extends GroupItem {
     ...
     */
    addPromptArgument(promptArgument) {
        if (this.promptArguments.includes(promptArgument))
            return false;
     ...
     */
    removePromptArgument(promptArgument) {
