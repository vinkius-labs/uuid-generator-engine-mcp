 ...
 */
export async function mintDelegationToken(scope, ttlSeconds, secret, issuer = 'mcpfusion-gateway', carryOverState, store, traceparent) {
    ...
    if (carryOverState !== undefined) {
        if (byteLength(carryOverState) > CLAIM_CHECK_THRESHOLD_BYTES) {
            if (!store) {
                throw new Error('[mcpfusion/core] carryOverState exceeds 2 KB but no HandoffStateStore was provided. ' +
