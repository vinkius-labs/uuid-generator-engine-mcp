 ...
 * ```
 */
export type TelemetryEvent = DebugEvent | ExecuteWithRecoveryEvent | DlpRedactEvent | PresenterSliceEvent | PresenterRulesEvent | SandboxExecEvent | FsmTransitionEvent | TopologyEvent | HeartbeatEvent | SecurityFirewallEvent | SecurityAuditEvent | SecurityRateLimitEvent;
/**
